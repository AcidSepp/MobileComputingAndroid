...
public class StudentClassroomsActivity extends AppCompatActivity {
    ...
    private StudentClassroomsAdapter studentClassroomsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_classrooms);
        ...
        studentClassroomsAdapter = new StudentClassroomsAdapter(this.getApplicationContext(), shownClassrooms, email, password);
        listView.setAdapter(studentClassroomsAdapter);
        ...
        final ClassroomsRequest.Listener listener = new ClassroomsRequest.Listener() {
            ...
            public void onSuccess(final LinkedList<Classroom> rooms) {
                StudentClassroomsActivity.this.classrooms.clear();
                StudentClassroomsActivity.this.classrooms.addAll(rooms);
                fillLayout();
                requesting = false;
            }
        ...
        if (!showAllClassrooms) {
            classroomsRequest = ClassroomsRequest.getStudentSubscribedClassroomsRequest(listener, this.getApplicationContext());
        } else {
    ...
    private synchronized void fillLayout() {
        ...
        studentClassroomsAdapter.notifyDataSetChanged();
